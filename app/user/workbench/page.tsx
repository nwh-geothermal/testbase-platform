...
export default function WorkbenchPage() {
  ...
  return (
    <div className='flex flex-1 flex-col bg-gradient-to-br from-amber-50 via-white to-blue-50'>
      ...
      <div className='max-w-[90rem] mx-auto px-3 sm:px-4 lg:px-6 pt-20 pb-20 relative'>
            ...
            <Card className='shadow-sm h-full'>
              ...
              <CardContent className='space-y-4'>
                <div className='border-2 border-dashed border-orange-200 rounded-xl p-4 bg-orange-50/50'>
                  ...
                  />
                  {uploadHint && (
                    <p className='text-sm text-orange-700 mt-2'>{uploadHint}</p>
                  )}
                </div>
